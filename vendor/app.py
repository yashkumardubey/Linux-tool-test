...
DB_PATH = os.environ.get("CM_DB_PATH",
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "data", "customers.db"))

# ── License constants (must match PatchMaster product) ─────────
DEFAULT_SIGN_KEY = os.environ.get("LICENSE_SIGN_KEY", "PatchMaster-License-SignKey-2026-Secure")
TOOL_VERSION = "2.0"
VERSION_COMPAT = "2.x"
...
# ── License Generation ─────────────────────────────────────────
def generate_license_key(tier, plan, customer, max_hosts=0, sign_key=None):
